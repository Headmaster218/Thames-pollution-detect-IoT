...
# Load dataset
data = pd.read_csv('2.7cos_transformed.csv', skiprows=1)  # Skip the first row (header)

# Prepare input and output data
X = data.iloc[:, [3, 4, 5, 6, 7, 9, 10]].values  # Columns 4, 5, 6, 7, 8, 10, 11 as input
...
class NeuralNetwork(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(7, 64)  # Adjust input size to 7
