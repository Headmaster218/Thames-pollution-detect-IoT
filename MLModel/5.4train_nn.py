...
# Load dataset
data = pd.read_csv('5.3same_feature_data.csv', skiprows=1)  # Skip the first row (header)
...
# Save the scaler
joblib.dump(scaler, '5.3scaler.pkl')
...
scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=100, gamma=0.944)
